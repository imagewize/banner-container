...
define('IWZ_BANNER_CONTAINER_VERSION', '1.0.1');
...
require_once IWZ_BANNER_CONTAINER_PATH . 'includes/class-banner-container.php';
require_once IWZ_BANNER_CONTAINER_PATH . 'includes/class-banner-container-welcome.php';
