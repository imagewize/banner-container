...
class Banner_Iframe_Settings {
    ...
    public function add_admin_menu() {
        $this->page_hook = add_menu_page(
            __('Banner Iframe Settings', 'banner-iframe-plugin'),
            __('Banner Iframes', 'banner-iframe-plugin'),
            'manage_options',
    ...
    public function display_admin_page() {
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                <?php settings_fields('banner_iframe_settings'); ?>
                
                <div class="banner-iframe-notice">
                    <p><?php _e('Configure your banner iframe settings below. Enable a location and enter the HTML code for the banner.', 'banner-iframe-plugin'); ?></p>
                </div>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="banner_<?php echo esc_attr($location_key); ?>_enabled">
                                        <?php printf(__('Enable %s Banner', 'banner-iframe-plugin'), esc_html($location_label)); ?>
                                    </label>
                                </th>
                                <td>
                            ...
                            <tr class="banner-iframe-code-field <?php echo $enabled ? '' : 'hidden'; ?>">
                                <th scope="row">
                                    <label for="banner_<?php echo esc_attr($location_key); ?>_code">
                                        <?php printf(__('%s Banner Code', 'banner-iframe-plugin'), esc_html($location_label)); ?>
                                    </label>
                                </th>
                                <td>
                                    ...
                                    <p class="description">
                                        <?php _e('Enter the iframe or banner code to insert at this location.', 'banner-iframe-plugin'); ?>
                                    </p>
                                </td>
                            </tr>
                                ...
                                <tr class="banner-iframe-code-field <?php echo $enabled ? '' : 'hidden'; ?>">
                                    <th scope="row">
                                        <label for="banner_content_position">
                                            <?php _e('Content Banner Position', 'banner-iframe-plugin'); ?>
                                        </label>
                                    </th>
                                    <td>
                                        <select id="banner_content_position" name="banner_content_position">
                                            <option value="top" <?php selected('top', $position); ?>>
                                                <?php _e('Top of content', 'banner-iframe-plugin'); ?>
                                            </option>
                                            <option value="bottom" <?php selected('bottom', $position); ?>>
                                                <?php _e('Bottom of content', 'banner-iframe-plugin'); ?>
                                            </option>
                                            <option value="after_paragraph" <?php selected('after_paragraph', $position); ?>>
                                                <?php _e('After specific paragraph', 'banner-iframe-plugin'); ?>
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                                <tr class="banner-iframe-paragraph-field <?php echo ($enabled && $position == 'after_paragraph') ? '' : 'hidden'; ?>">
                                    <th scope="row">
                                        <label for="banner_content_paragraph">
                                            <?php _e('Paragraph Number', 'banner-iframe-plugin'); ?>
                                        </label>
                                    </th>
                                    <td>
                                        ...
                                        <p class="description">
                                            <?php _e('Display after which paragraph? (Enter 1 for after first paragraph, 2 for second, etc.)', 'banner-iframe-plugin'); ?>
                                        </p>
                                    </td>
                                </tr>
                                <tr class="banner-iframe-code-field <?php echo $enabled ? '' : 'hidden'; ?>">
                                    <th scope="row">
                                        <label for="banner_content_post_types">
                                            <?php _e('Apply to Post Types', 'banner-iframe-plugin'); ?>
                                        </label>
                                    </th>
                                    <td>
                                        ...
                                        <?php endforeach; ?>
                                        <p class="description">
                                            <?php _e('Select which post types should display this content banner.', 'banner-iframe-plugin'); ?>
                                        </p>
                                    </td>
                                </tr>
                            <?php endif; ?>
                ...
                <?php submit_button(__('Save Banner Settings', 'banner-iframe-plugin')); ?>
            </form>
        </div>
